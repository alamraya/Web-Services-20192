...
public function province($province_id = NULL) {
    ...
    $rest_client = new cek_ongkir($this->api_key, 'province', $this->account_type);
...
public function city($province_id = NULL, $city_id = NULL) {
    ...
    $rest_client = new cek_ongkir($this->api_key, 'city', $this->account_type);
    return $rest_client->get($params);
}
...
public function cost($origin, $destination, $weight, $courier) {
    ...
    $rest_api = new cek_ongkir($this->api_key, 'cost', $this->account_type);
...
public function internationalOrigin($province_id = NULL, $city_id = NULL) {
    ...
    $rest_client = new cek_ongkir($this->api_key, 'internationalOrigin', $this->account_type);
    return $rest_client->get($params);
}
...
public function internationalDestination($country_id = NULL) {
    ...
    $rest_client = new cek_ongkir($this->api_key, 'internationalDestination', $this->account_type);
    return $rest_client->get($params);
}
...
public function internationalCost($origin, $destination, $weight, $courier) {
    ...
    $rest_client = new cek_ongkir($this->api_key, 'internationalCost', $this->account_type);
    return $rest_client->post($params);
}
...
public function currency() {
    $rest_client = new cek_ongkir($this->api_key, 'currency', $this->account_type);
...
public function waybill($waybill_number, $courier) {
    ...
    $rest_client = new cek_ongkir($this->api_key, 'waybill', $this->account_type);
    return $rest_client->post($params);
}
