...
@section('nama_halaman','Update Produk')
...
<div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 35%; background-image: url({{asset('admin/assets/img/theme/profile-cover.jpg')}}); background-size: cover; background-position: center top;">
    ...
    <div class="row">
        ...
        <div class="card bg-secondary shadow">
            <div class="card-body">
            <form role="form" action="/products_dashboard/{{$product->data->id}}/updating" method="POST">
                @csrf
                <h6 class="heading-small text-muted mb-4">INFORMASI PRODUK</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group focused">
                            ...
                            <input type="text" name="name" id="name_produk" class="form-control form-control-alternative" placeholder="nama produk" value="{{$product->data->name}}" required>
                        </div>
                        </div>
                        <div class="col-lg-6">
                        <div class="form-group focused">
                            <label class="form-control-label" for="input-price">Harga</label>
                            <input type="text" name="price" id="input-price" class="form-control form-control-alternative" placeholder="ex. 80000" value="{{$product->data->price}}" required>
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group focused">
                                ...
                                <input type="number" min="0" name="stock" id="input-stock" class="form-control form-control-alternative" placeholder="0" value="{{$product->data->stock}}" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group focused">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group focused">
                                <input type="text" name="cover_img" id="cover_img" class="form-control form-control-alternative mb-5" placeholder=".jpg .png .jpeg" value="{{$product->data->cover_img}}" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        ...
                        <textarea rows="10" name="description" class="form-control form-control-alternative" placeholder="" value="{{$product->data->description}}" required></textarea>
                        </div>
                        </div>
                    </div>
                    </div>
