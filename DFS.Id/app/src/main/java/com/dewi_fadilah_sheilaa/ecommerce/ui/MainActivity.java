...
import com.dewi_fadilah_sheilaa.ecommerce.adapter.MainCategoriesAdapter;
import com.dewi_fadilah_sheilaa.ecommerce.adapter.MainSliderAdapter;
import com.dewi_fadilah_sheilaa.ecommerce.adapter.RecentlyAddedProducsAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    ArrayList<Ad> getFakeAds(){
        ...
        ads.add(new Ad("http://192.168.42.28/Ecommerce_server/img/celana.jpg"));
        ads.add(new Ad("http://192.168.42.28/Ecommerce_server/img/dress.jpg"));
        ads.add(new Ad("http://192.168.42.28/Ecommerce_server/img/rok.jpg"));
        return ads;
    }
}
