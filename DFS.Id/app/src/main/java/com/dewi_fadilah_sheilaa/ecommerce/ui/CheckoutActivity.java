...
import com.dewi_fadilah_sheilaa.ecommerce.adapter.CheckoutViewPagerAdapter;
import com.dewi_fadilah_sheilaa.ecommerce.model.Address;
import com.dewi_fadilah_sheilaa.ecommerce.utils.CustomViewPager;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent != null && intent.hasExtra("total")){
            ...
            mTotalValueTxt.setText("Rp" +total);
        }
