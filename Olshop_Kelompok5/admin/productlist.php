...
//$product_id=$_GET['product_id'];
///////picture delete/////////
//$result=mysqli_query($con,"delete from products where product_id='$product_id'")or die("query is incorrect...");
	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <td>$price</td>
                        <td>
                        <a class=' btn btn-success' href='editproduct.php?products_id=$product_id' type='button' rel='tooltip' title='' class='btn btn-info btn-link btn-sm' data-original-title='Edit'> EDIT<div class='ripple-container'></div></a>
